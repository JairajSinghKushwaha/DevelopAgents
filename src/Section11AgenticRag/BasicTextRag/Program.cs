...
public class Program
{
    public static async Task Main()
    {
        ...
        // Create the AI agent with the TextSearchProveder as the AI context provider
    ...
    // This data usually comes from Database or SharePoint.
    ...
    private static readonly string CorporatePolicy = """
        ...
        - Tier 1 Employees: Must be in the office 3 days a weak (Tuesday, Wednesday, Thursday).
        - Tier 2 Employees: Fully remote permitted.
        - Hardware Budget: $500 every 2 years for home office equipment.
    ...
    /// In production, this would connect to Azure AI Search or another search technology (like another query for vector databases).
    /// </summary>
    private static Task<IEnumerable<TextSearchProvider.TextSearchResult>> SearchAdapter(string query, CancellationToken cancellationToken)
    {
            ...
            query.Contains("days", StringComparison.OrdinalIgnoreCase))
        {
            results.Add(new()
            {
                ...
                Text = "Tier 1 Employees: Must be in the office 3 day a week (Tuesday, Wednessday, Thursday). Tier 3 Employees: Fully remote permitted."
            });
        }
