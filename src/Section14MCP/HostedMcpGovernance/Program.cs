...
// Define the Hosted MCP Tool with Governance
...
AIAgent mentorAgent = new AzureOpenAIClient(new Uri(endpoint), new AzureCliCredential())
    ...
    .AsAIAgent(
        ...
        instructions: """
          Search Microsoft Learn for the exact topic.
          Search Microsoft Learn code samples for implementation examples.
          If a relevant page is found, fetch the complete page.
          Prefer current Microsoft Agent Framework documentation over general search results.
          Cite the exact class/type names and namespaces.
          Do not guess APIs that aren't present in the retrieved documentation.
        """,
...
// Initial Execution (The agent realizes it needs to search and pauses)
...
// The Governance Loop (Human-in-the-Loop)
